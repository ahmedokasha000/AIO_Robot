...
class motors ():
    def __init__(self, pins_config, pigpio_istance, init_speed=0):
        ...
        self.last_time_check_step_l = pi.get_current_tick()
        self.last_time_check_step_r = pi.get_current_tick()
    ...
    def update_speed(self):
        ...
        if (pigpio.tickDiff(self.last_time_check_step_l,t_us_now) >=self.l_speed) and (self.l_speed > 100):
        ...
        if (pigpio.tickDiff(self.last_time_check_step_r,t_us_now) >=self.r_speed) and (self.r_speed > 100):
...
if __name__ == '__main__':
    try:
        ...
        steppers = motors(PINS_CONFIG, pi, init_speed=0)
#  
